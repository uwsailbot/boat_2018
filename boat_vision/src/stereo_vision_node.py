...
def get_buoy_coords(img, pub):
	...
	threshold_img = cv2.inRange(hsv_img, nparray([0, 165, 200]), nparray([14, 245, 255]))  # Overcast
...
# This in combination with a synchronized retrieve() provides the most in-sync images.
